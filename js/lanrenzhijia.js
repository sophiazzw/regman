...
jQuery.fn.gallery = function(config) {
    ...
    var toLeft = function(callback) {
	 $active = $('.btnlun  a.active').next();
         if ( $active.length === 0) { //If paging reaches the end...
         	$active = $('.btnlun  a:first'); //go back to first
                                //alert($active.length);
          }
          $(".btnlun a").removeClass('active'); //Remove all active class
    ...
    var toRight = function(callback) {
	 $active1 = $('.btnlun  a.active').prev();
          if ( $active1.length === 0) { //If paging reaches the end...
            $active1 = $('.btnlun  a:last'); //go back to first
              }
            $(".btnlun a").removeClass('active'); //Remove all active class
	...
	$(".btnlun1").unbind("click");
	$(".btnlun2").unbind("click");
	$(".btnlun3").unbind("click");
	$(".btnlun4").unbind("click");
    };
...
function is_bind(){
	if($(".btnlun2").data("events")["click"] ){
	}


}	

	$(".btnlun1").bind("click",function(){
		stopAutoGo();
	//	is_bind();
		$active = $('.btnlun  a.active');
